  ...
  <body id="index">
	...
	<div class="headerBg">
		<div class="headerTop"> 
			...
			<div class="top_right">
	      		<?php if($uname != ''): ?><a href="">test</a>|<a href="javascript:;" onclick="logout(/web/index.php/Home/Index/details.html,this)">退出</a></div>
				<?php else: ?>
        ...
        <div class="colMain">
            ...
            <div class="postContainer unTagImgs pb15">
              <div class="sectionleft sectionright ">
                <div class="unTagImgsCon" style=" line-height:2.5em; margin-bottom:25px; font-size:14px;">
                  <img src="/web/<?php echo ($var['content']); ?>" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="afterbar" style="height:28px;">
              <div class="vote">
                <ul class="itemVoteContainer">
                  <li>
                    <a onclick="dingcai('ding','<?php echo ($var['id']); ?>','dingcai_ding_<?php echo ($var['id']); ?>')" href="javascript:void(0);"class="itemVoteUp" title="顶这个热门笑话">
                      <span class="icon"></span>
                    </a>
                  </li>
                  <li>
                    <h3 class="itemLoveCount" id="dingcai_ding_<?php echo ($var['id']); ?>"><?php echo ($var['ding']); ?></h3>
                  </li>
                  <li>
                    <a onclick="dingcai('cai','<?php echo ($var['id']); ?>','dingcai_ding_<?php echo ($var['id']); ?>')" href="javascript:void(0);" class="itemVoteDown" title="踩这个热门笑话">
                      <span class="icon"></span>
                    </a>
                  </li>
                  <li>
                    <h3 class="itemLoveCount" id="dingcai_cai_<?php echo ($var['id']); ?>"><?php echo ($var['cai']); ?></h3>
                  </li>
              ...
              <div class="sideViews" style="">
                ...
                <span class="sideViewNub fr">191</span>
                <span class="sideView fr" title="笑话浏览次数"></span>
                <div class="shareVline fr"></div>
                <span class="sideTipsIcon fr" title=" 卖萌，创意"></span>
              </div>
            </div>
          </div>
          <div class="ad630"></div>
          ...
          <script type="text/javascript">
            $(document).ready(function() {
              getcomment('<?php echo ($var['id']); ?>');
            });
          </script>
          <div id="showcomment_2921" style="margin-top:10px;"></div>
        ...
        <div class="landing_right">
          ...
          <form id="loginform" action="/web/index.php/Home/Index/login" method="post">
            ...
            <div class="landing_button">
              <input type="hidden" name="refurl" value="/web/index.php/Home/Index/details.html">
